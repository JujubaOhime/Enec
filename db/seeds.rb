...
lot.term = Rails.root.join("app/assets/images/termo.pdf").open
lot.save!
...
us = User.create!(name:"teste da silva", telephone:"2199588584", email: "teste@teste.com" ,password: "111111", admin: false ,lot_id: "1", delegation: "IN Junior", cpf: "18182888234", rg: "319877367", rg_issuing_body: "detran-rj", birth_date: "Mon, 10 Dec 2018 23:40:30 UTC +00:00", gender:"Masculino", address:"avenida teste, numero teste", city: "Rio de janeiro", state: "Rio de Janeiro", course: "Sistemas de Informação", period: "5 periodo", IES_id: 1)
