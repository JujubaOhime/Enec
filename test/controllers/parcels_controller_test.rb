...
class ParcelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parcel" do
    assert_difference('Parcel.count') do
      post parcels_url, params: { parcel: { payment_id: @parcel.payment_id, status: @parcel.status, value: @parcel.value } }
    end
  ...
  test "should update parcel" do
    patch parcel_url(@parcel), params: { parcel: { payment_id: @parcel.payment_id, status: @parcel.status, value: @parcel.value } }
