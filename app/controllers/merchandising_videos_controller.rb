class MerchandisingVideosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @merchandising_video.save
        format.html { redirect_to @merchandising_video, notice: 'Merchandising video was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @merchandising_video.update(merchandising_video_params)
        format.html { redirect_to @merchandising_video, notice: 'Merchandising video was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to merchandising_videos_url, notice: 'Merchandising video was successfully destroyed.' }
