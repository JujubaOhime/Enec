class LandingPage::SponsorsAndSupportersTitlesController < ApplicationController
  before_action do
  ...
  def index
    @sponsors_and_supporters_titles =LandingPage::SponsorsAndSupportersTitle.all
  end
  ...
  def new
    @sponsors_and_supporters_title =LandingPage::SponsorsAndSupportersTitle.new
  end
  ...
  def create
    @sponsors_and_supporters_title =LandingPage::SponsorsAndSupportersTitle.new(sponsors_and_supporters_title_params)
  ...
  private
    ...
    def set_sponsors_and_supporters_title
      @sponsors_and_supporters_title =LandingPage::SponsorsAndSupportersTitle.find(params[:id])
    end
