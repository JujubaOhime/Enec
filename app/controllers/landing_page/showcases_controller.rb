class LandingPage::ShowcasesController < ApplicationController
  before_action do
  ...
  # GET /showcases.json
  def index
    @showcases =LandingPage::Showcase.all
  end
  ...
  # GET /showcases/new
  def new
    @showcase =LandingPage::Showcase.new
  end
  ...
  # POST /showcases.json
  def create
    @showcase =LandingPage::Showcase.new(showcase_params)
  ...
  private
    ...
    def set_showcase
      @showcase =LandingPage::Showcase.find(params[:id])
    end
